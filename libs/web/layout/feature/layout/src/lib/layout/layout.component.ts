...
import { MainViewComponent } from '@car-dashboard-shared/ui-main-view';
import { SideBarComponent } from '@car-dashboard-shared/ui-side-bar';
import { TopBarComponent } from '@car-dashboard-shared/ui-top-bar';
import { filter, Subscription } from 'rxjs';

@Component({
  selector: 'lib-layout',
  standalone: true,
  imports: [CommonModule, TopBarComponent, MainViewComponent, RouterModule],
...
export class LayoutComponent {
  ...
  hideProfileMenu() {
    ...
    this.layoutService.profileSidebarVisible.set(false);
  }
